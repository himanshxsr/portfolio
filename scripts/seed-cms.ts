...
add("profile", "main", personalData as unknown as Record<string, unknown>);

NAV_LINKS.forEach((item, index) =>
  add("navigation", item.label.toLowerCase(), { ...item, enabled: true }, index)
);
projects.forEach((project, index) =>
  add("project", project.id, project as unknown as Record<string, unknown>, index)
);
...
[
  ...
  { slug: "about", title: "About Me", subtitle: "Get to know the developer behind the code", sectionNumber: "01" },
  { slug: "skills", title: "Skills & Technologies", subtitle: "The tools and technologies I use to bring ideas to life", sectionNumber: "02" },
  { slug: "projects", title: "Projects", subtitle: "A selection of things I've built", sectionNumber: "03" },
  { slug: "experience", title: "Experience", subtitle: "My professional journey so far", sectionNumber: "04" },
  { slug: "contact", title: "Get In Touch", subtitle: "Have a project in mind? Let's build something together.", sectionNumber: "05" },
  { slug: "blog", title: "Blog", subtitle: "Thoughts on development, architecture, and AI", sectionNumber: "06" },
  { slug: "loading", title: "Loading", subtitle: "", sectionNumber: "", label: "Initializing..." },
